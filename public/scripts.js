import {
  initializeApp
} from "https://www.gstatic.com/firebasejs/9.x/firebase-app.js";
import {
  getDatabase,
  ref,
  set
...
import {
  firebaseConfig
} from "./firebaseConfig.js"; // Ensure the path is correct
...
document.getElementById("submit-button").addEventListener("click", () => {
  ...
  if (thoughts) {
    set(ref(db, 'messages/' + Date.now()), {message : thoughts})
        .then(() => {
          console.log("Message sent successfully!");
          document.getElementById("thoughts").value = ""; // Clear input box
        })
...
document.getElementById('no-button')
    .addEventListener('click', showResponseCloud);
document.getElementById('submit-button')
    .addEventListener('click', submitThoughts);
...
const captions = [
  ...
  {text : "tex1", image : "path/to/image2.jpg", gif : ""},
  {text : "text", image : "path/to/image3.jpg", gif : ""},
  {text : "text ", image : "path/to/image4.jpg", gif : ""},
  {text : "text", image : "path/to/image5.jpg", gif : ""},
  {text : "text", image : "path/to/image6.jpg", gif : ""},
  {text : "text", image : "path/to/HN.jpg", gif : ""},
  {text : "text", image : "path/to/image8.jpg", gif : ""},
  {text : "text", image : "path/to/image9.jpg", gif : ""},
  {
